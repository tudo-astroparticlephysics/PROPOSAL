...
//#ifndef EBIG // bounds of parameterizations
//    #define EBIG 1.e14 //EBIG = BIGENERGY
//#endif
...
class MathModel{
	...
	public:
		...
		// Getter
                ...
                //double getcomputerPrecision() { return computerPrecision; }




    protected: // maybe we need a virtual function here to make the class virtual (compare javacode..)
                //const static double computerPrecision=1.e-10; // 1.e-11 may also work
    private:
