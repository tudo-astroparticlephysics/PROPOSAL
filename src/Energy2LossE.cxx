...
using namespace std;
        ...
        Energy2LossE::Energy2LossE(Energy2Loss *e2loss) : Energy2Loss(e2loss)
        {
            df = false;
            jt = false;
        ...
        void Energy2LossE::set_jt(bool newJT){jt = newJT;}
        void Energy2LossE::set_df(bool newDF){df = newDF;}
