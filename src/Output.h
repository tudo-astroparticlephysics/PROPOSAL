		...
		// Functions
            ...
            //----------------------------------------------------------------------------------------------------//
                 ...
                 */
                        ...
                        static void PROPOSALParticleToFileAscii(PROPOSALParticle *p,std::string filename, bool isPrimary);

                        static void PROPOSALParticleToFileRaw(PROPOSALParticle *p, std::string filename, bool isPrimary);
