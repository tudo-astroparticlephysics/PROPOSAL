...
Bremsstrahlung::Bremsstrahlung() : vMax_(0),vUp_(0),vMin_(0),form_(1),lorenzCut_(1.e6)
        {
...
Bremsstrahlung::Bremsstrahlung(Bremsstrahlung *cros): vMax_(0),vUp_(0),vMin_(0),form_(1),lorenzCut_(1.e6)
        {
            lorenz_= false;
            init_ = true;
...
Bremsstrahlung::Bremsstrahlung(CrossSections *cros) : CrossSections(*cros), vMax_(0),vUp_(0),vMin_(0),form_(1),lorenzCut_(1.e6)
        {
           lorenz_= false;
	...
	void Bremsstrahlung::setLpm()
        ...
        BremsContinuous* Bremsstrahlung::get_Continuous() {return continuous_;}
        BremsStochastic* Bremsstrahlung::get_Stochastic() {return stochastic_;}

        // Setter

        void Bremsstrahlung::set_continous(BremsContinuous *continous){continuous_ = continous;}
        void Bremsstrahlung::set_stochastic(BremsStochastic *stochastic){stochastic_ = stochastic;}

        void Bremsstrahlung::set_vMax(double vMax){vMax_ = vMax;}
        void Bremsstrahlung::set_vUp(double vUp){vUp_ = vUp;}
        void Bremsstrahlung::set_vMin(double vMin){vMin_ = vMin;}

        void Bremsstrahlung::set_integral(Integral *integral){integral_ = integral;}

        void Bremsstrahlung::set_form(int form){form_ = form;}

        void Bremsstrahlung::set_init(bool init){init_ = init;}
        void Bremsstrahlung::set_eLpm(double eLpm){eLpm_ = eLpm;}
        void Bremsstrahlung::set_xo(double xo){xo_ = xo;}

        void Bremsstrahlung::set_lorenz(bool lorenz){lorenz_ = lorenz;}
        void Bremsstrahlung::set_lorenzCut(double lorenzCut){lorenzCut_ = lorenzCut;}
