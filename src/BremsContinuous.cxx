...
BremsContinuous::BremsContinuous()
        ...
        BremsContinuous::BremsContinuous(Bremsstrahlung *cros) : Bremsstrahlung (*cros)
        {
                 set_jt(false);
	...
	// Memberfunctions
		...
		// Setter
                ...
                void BremsContinuous::set_integral(Integral *integral){integral_ = integral;}
                void BremsContinuous::set_interpolateJ(Interpolate* interpolateJ){interpolateJ_ = interpolateJ;}
                void BremsContinuous::set_jt(bool newjt){jt_ = newjt;}
