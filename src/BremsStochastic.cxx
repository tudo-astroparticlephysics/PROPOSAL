...
using namespace std;
	...
	// constructors
        ...
        BremsStochastic::BremsStochastic(Bremsstrahlung *cros) : Bremsstrahlung(*cros)
        {
            ...
            //interpolateJ_.resize(medium_->get_numCompontents()); <---- not necessary here, i guess (jhk)

            //interpolateJo_.resize(medium_->get_numCompontents()); <---- not necessary here, i guess (jhk)
	...
	double BremsStochastic::dNdx(double rnd){
		...
		// Setter
                ...
                void BremsStochastic::set_integral(vector<Integral*> integral){VectorOfIntegral_ = integral;}
                void BremsStochastic::set_h(double* h){h_ = h;}
		void BremsStochastic::set_sum(double sum){sum_ = sum;}

                void BremsStochastic::set_interpolateJ(Interpolate* interpolateJ){interpolateJ_ = interpolateJ;}
                void BremsStochastic::set_jt(bool newjt){jt_ = newjt;}
		void BremsStochastic::set_rnd(double rnd){rnd_ = rnd;}

                void BremsStochastic::set_interpolateJo(Interpolate* interpolateJo){interpolateJo_ = interpolateJo;}
