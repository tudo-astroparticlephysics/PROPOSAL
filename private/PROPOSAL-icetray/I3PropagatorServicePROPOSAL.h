...
public:
 ...
 private:
  ...
  PROPOSALParticle::ParticleType GeneratePROPOSALType(const I3Particle& p);
  I3Particle::ParticleType GenerateI3Type(PROPOSALParticle::ParticleType ptype_PROPOSAL);
