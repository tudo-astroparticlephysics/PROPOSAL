...
EpairIntegral::EpairIntegral(const EpairIntegral& brems): CrossSectionIntegral(brems)
{
}
...
double EpairIntegral::CalculatedEdx(double energy)
{
    ...
    for(int i=0; i<parametrization_->GetMedium().GetNumComponents(); i++)
    {
        ...
        if(rflag)
        {
            ...
            sum         +=  dedx_integral_.Integrate(1-limits.vUp, r2, boost::bind(&EpairIntegral::FunctionToDEdxIntegralReverse, this, energy, _1),2)
                        +   dedx_integral_.Integrate(r2, 1-r1, boost::bind(&EpairIntegral::FunctionToDEdxIntegralReverse, this, energy, _1),4);
            // sum         +=  dedx_integral_.Integrate(1-limits.vUp, r2, boost::bind(&Parametrization::FunctionToDEdxIntegral, &parametrization_, energy, _1),2)
            //             +   dedx_integral_.Integrate(r2, 1-r1, boost::bind(&Parametrization::FunctionToDEdxIntegral, &parametrization_, energy, _1),4);
