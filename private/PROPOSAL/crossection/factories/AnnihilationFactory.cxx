    ...
    std::shared_ptr<const InterpolationDef> interpolation_def = nullptr) const
{
    ...
    std::invalid_argument("Annihilation not registered!");
}
...
// ------------------------------------------------------------------------- //
void AnnihilationFactory::Register(
...
// ------------------------------------------------------------------------- //
AnnihilationFactory::Enum AnnihilationFactory::GetEnumFromString(
...
// ------------------------------------------------------------------------- //
std::string AnnihilationFactory::GetStringFromEnum(
    const AnnihilationFactory::Enum& enum_t)
{
