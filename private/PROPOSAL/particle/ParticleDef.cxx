...
PARTICLE_IMP(EMinus, ME, -1.0, -1.0)
PARTICLE_IMP(EPlus, ME, -1.0, 1.0)

PARTICLE_IMP(StauMinus, MSTAU, LSTAU, -1.0)
PARTICLE_IMP(StauPlus, MSTAU, LSTAU, 1.0)
...
PARTICLE_IMP(PMinus, MP, -1.0, -1.0)
PARTICLE_IMP(PPlus, MP, -1.0, 1.0)

PARTICLE_IMP(NuE, 0.0, -1.0, 0.0)
PARTICLE_IMP(NuEBar, 0.0, -1.0, 0.0)

PARTICLE_IMP(NuMu, 0.0, -1.0, 0.0)
PARTICLE_IMP(NuMuBar, 0.0, -1.0, 0.0)

PARTICLE_IMP(NuTau, 0.0, -1.0, 0.0)
PARTICLE_IMP(NuTauBar, 0.0, -1.0, 0.0)
...
PARTICLE_IMP(Monopole, MMON, -1.0, CMON)
PARTICLE_IMP(Gamma, 0.0, -1.0, 0.0)
PARTICLE_IMP(StableMassiveParticle, MSMP, LSMP, -1.0)
