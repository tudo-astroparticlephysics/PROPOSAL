...
//Linear_Spline::Linear_Spline(std::vector<Polynom> splines, std::vector<double> subintervall) :
...
//void Linear_Spline::calculate_splines(std::vector<double> x, std::vector<double> y) 
//{
//}
...
Cubic_Spline::Cubic_Spline(std::vector<Polynom> splines, std::vector<double> subintervall) :
    Spline(splines, subintervall)
{
}
...
Cubic_Spline::Cubic_Spline(const Cubic_Spline& spline) :
    Spline( spline )
{
}

void Cubic_Spline::calculate_splines(std::vector<double> x, std::vector<double> y) 
{
...
//         std::vector<linear_spline_container> spline_container = GetSplineContainer();
...
Cubic_Spline::Cubic_Spline(std::string path, bool binary) :
    Spline(path)
{
