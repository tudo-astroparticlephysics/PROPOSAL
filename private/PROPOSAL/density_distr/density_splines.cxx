...
double Density_splines::Helper_function(Vector3D xi, Vector3D direction,
                                        double res, double l) const {
...
double Density_splines::Correct(Vector3D xi, Vector3D direction, double res,
...
double Density_splines::Integrate(Vector3D xi, Vector3D direction,
                                  double l) const {
...
double Density_splines::Evaluate(Vector3D xi, Vector3D direction,
                                 double l) const {
  double delta = axis_->GetEffectiveDistance(xi, direction);
...
double Density_splines::Calculate(Vector3D xi, Vector3D direction,
