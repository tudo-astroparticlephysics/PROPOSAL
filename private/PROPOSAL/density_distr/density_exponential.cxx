...
double Density_exponential::Correct(Vector3D xi, Vector3D direction, double res,
...
double Density_exponential::Integrate(Vector3D xi, Vector3D direction,
                                      double l) const {
  double delta = GetEffectiveDistance(xi, direction);
...
double Density_exponential::Calculate(Vector3D xi, Vector3D direction,
                                      double distance) const {
  return Integrate(xi, direction, distance) - Integrate(xi, direction, 0);
}

double Density_exponential::Evaluate(Vector3D xi, Vector3D direction,
                                     double l) const {
  double delta = GetEffectiveDistance(xi, direction);
