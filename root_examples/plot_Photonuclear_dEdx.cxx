...
int main()
{
    ...
    for(unsigned int i = 0 ; i < graphs.size() ; i++)
    {
        ...
        {
            if (photo.at(i)->GetMedium()->GetType() == MediumType::Water)
            {
            ...
            else if(photo.at(i)->GetMedium()->GetType() == MediumType::Hydrogen)
            {
            ...
            else if(photo.at(i)->GetMedium()->GetType() == MediumType::Uranium)
            {
    ...
    for(unsigned int i = 0 ; i < graphs.size() ; i++)
    {
        if(photo.at(i)->GetMedium()->GetType() == MediumType::Hydrogen)
        {
            switch (photo.at(i)->GetParametrization())
            {
                case ParametrizationType::PhotoKokoulinShadowBezrukovSoft:
        ...
        else if(photo.at(i)->GetMedium()->GetType() == MediumType::Water)
        {
            switch (photo.at(i)->GetParametrization())
            {
                case ParametrizationType::PhotoKokoulinShadowBezrukovSoft:
