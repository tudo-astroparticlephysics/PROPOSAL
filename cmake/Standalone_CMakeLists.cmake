...
IF(ADD_PYTHON)
    ...
    pybind11_add_module(proposal SHARED ${PYTHON_SRC_FILES})
    target_include_directories(proposal PRIVATE ${PYTHON_INCLUDE_DIRS})
    target_include_directories(proposal PRIVATE ${PROJECT_SOURCE_DIR}/public/Interface/python )
    target_link_libraries(proposal PRIVATE PROPOSAL)
    target_compile_options(proposal PRIVATE -fvisibility=hidden)
    install(TARGETS proposal EXPORT PROPOSALTargets DESTINATION ${CMAKE_INSTALL_LIBDIR})
ELSE(ADD_PYTHON)
