...
void init_secondaries(py::module& m)
{
    ...
    py::class_<secondaries::Annihilation, std::shared_ptr<secondaries::Annihilation>>(m_sub, "Annihilation");
    ...
    py::class_<secondaries::Bremsstrahlung, std::shared_ptr<secondaries::Bremsstrahlung>>(m_sub, "Bremsstrahlung");
    ...
    py::class_<secondaries::Compton, std::shared_ptr<secondaries::Compton>>(m_sub, "Compton");
    py::class_<secondaries::NaivCompton, secondaries::Compton, std::shared_ptr<secondaries::NaivCompton>>(m_sub, "NaivCompton");

    py::class_<secondaries::EpairProduction, std::shared_ptr<secondaries::EpairProduction>>(m_sub, "EpairProduction");
    ...
    py::class_<secondaries::Ionization, std::shared_ptr<secondaries::Ionization>>(m_sub, "Ionization");
    ...
    py::class_<secondaries::MupairProduction, std::shared_ptr<secondaries::MupairProduction>>(m_sub, "MupairProduction");
    ...
    py::class_<secondaries::Photonuclear, std::shared_ptr<secondaries::Photonuclear>>(m_sub, "Photonuclear");

    py::class_<secondaries::PhotopairProduction, std::shared_ptr<secondaries::PhotopairProduction>>(m_sub, "PhotopairProduction");
    py::class_<secondaries::PhotoTsai, secondaries::PhotopairProduction, std::shared_ptr<secondaries::PhotoTsai>>(m_sub, "PhotoTsai");

    py::class_<secondaries::WeakInteraction, std::shared_ptr<secondaries::WeakInteraction>>(m_sub, "WeakInteraction");
